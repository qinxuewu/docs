...
### phpHbaseAdmin（hbase图形管理工具）
https://github.com/hivefans/phphbaseadmin
- phphbaseadmin是一个hbase管理员web工具，它使用thrift接口，php（CodeIgniter），python（cherrypy，kazoo），bootstrap，kendo ui，jquery等开发。

##  安装方法 
(1) 使用根目录中的 setup_centos5.sh 或者setup_centos6.sh 脚本安装所需环境<br>
(2) 启动hbase thrift server    <br> 
```
[root@CentOS124 ~]# cd /home/hbase-1.2.6.1/bin
[root@CentOS124 bin]# ./hbase-daemon.sh start thrift 
starting thrift, logging to /home/hbase-1.2.6.1/bin/../logs/hbase-root-thrift-CentOS124.out
[root@CentOS124 bin]# jps
6084 Jps
16046 HMaster
6045 ThriftServer
```
